 ...
 * location and a delete control, the editable note sits beneath it. */
...
export function CritPanelMock() {
  return (
    <div className="relative w-full max-w-[348px] border border-white/[0.14] bg-[#0b0b0c] font-sans text-[#f4f4f5] shadow-[0_36px_90px_-30px_rgba(0,0,0,0.85)]">
      ...
      <div className="flex items-center justify-between border-b border-white/[0.08] px-[13px] py-[11px]">
        <span className="flex items-center gap-2">
          <span className="bg-[#f4f4f5] px-1.5 py-[3px] font-mono text-[11px] leading-none font-semibold text-[#0b0b0c]">
            3
          </span>
          <span className="font-mono text-[11px] leading-none font-semibold tracking-[0.09em] uppercase text-[#d4d4d8]">
            Crits
          </span>
        </span>
        <span className="flex items-center gap-2">
          <span className="font-mono text-[9.5px] leading-none font-semibold tracking-[0.07em] uppercase text-[#7a7a7f]">
            Clear All
          </span>
        ...
        {CRITS.map((crit) => (
          ...
          >
            <div className="flex items-center justify-between gap-2">
              <span className="min-w-0 flex-1 font-mono text-[10px] break-all text-[#7a7a7f]">
                {crit.source}
              </span>
              <TrashIcon />
            </div>
      ...
      {/* footer — subagents toggle + copy */}
      <div className="flex flex-col gap-[9px] border-t border-white/[0.08] px-[13px] py-[11px]">
        <span className="flex items-center gap-[7px] text-[11px] text-[#8a8a8f]">
          <span
            aria-hidden
            className="size-[14px] shrink-0 border border-white/20 bg-[#161617]"
          />
          Launch subagents
        </span>
        <span className="flex items-center justify-center bg-[#f4f4f5] px-2.5 py-[9px] text-[12px] font-semibold text-[#0b0b0c]">
          Copy Crit Prompt
        </span>
      </div>
    </div>
